...
function initUI() {
    ...
    if (!isRecursive) {
        ...
        showDiv('treetable', false);
        //if (isDetachable) {
            readFile("tree.json", diff);
        //} else {
        //    diff("tree.json");
        //}
    } else {
...
$(document).ready(function () {
    ...
    if (isDetachable) {
        addFileChooserHandler();
    } else {
        createFileFromUrl('report_data/' + testName, testName, 'text/plain').then(file => mapFile());
    }
